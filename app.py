...
INDICATOR_CAVEATS: dict[str, str] = {
    ...
    # 아래 3개는 응답 라벨로 확인되는 사실만 인용(원인 단정 없음): 4점 척도 세부 보기가
    # ~'22 까지만 있고 '23 부터 2점 척도로 바뀐다. 척도 경계('22→'23)를 넘는 비교는 유의.
    "그린카드_인지도": (
        "⚠️ 연도별 응답 척도가 달라 비교 유의: '~'22는 4점 척도"
        "(전혀 모름/본 적 있음/조금 앎/잘 앎)에서 도출한 인지, "
        "'23~는 2점 척도(알고 있다/모르고 있다)의 직접 응답이다. "
        "척도가 바뀌는 '22→'23 구간은 곧이곧대로 비교하기 어렵다."
    ),
    "녹색매장_인지도": (
        "⚠️ 연도별 응답 척도가 달라 비교 유의: '~'22는 4점 척도"
        "(전혀 모름/본 적 있음/조금 앎/잘 앎), '23~는 2점 척도(인지/비인지)다. "
        "척도가 바뀌는 '22→'23 구간은 곧이곧대로 비교하기 어렵다."
    ),
    "환경표지_인지도": (
        "⚠️ 연도별 응답 척도가 달라 비교 유의: '~'22는 4점 척도"
        "(전혀 모름/본 적 있음/조금 앎/잘 앎)에서 도출한 인지, "
        "'23~는 2점 척도(인지/비인지)의 직접 응답이다. "
        "척도가 바뀌는 '22→'23 구간은 곧이곧대로 비교하기 어렵다."
    ),
    "저탄소제품_인지도": (
        "⚠️ 연도별 응답 척도가 달라 비교 유의: '~'22는 4점 척도"
        "(전혀 모름/본 적 있음/조금 앎/잘 앎), '23~는 2점 척도(알고 있음/모르고 있음)다. "
        "척도가 바뀌는 '22→'23 구간은 곧이곧대로 비교하기 어렵다."
    ),
}
