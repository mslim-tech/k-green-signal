...
| **6. RAG 검색** | `rag/chunking·index·retriever·answer.py` | 정형 데이터 위 **근거 인용 질의응답**(Chroma 검색 → 출처 인용 답변) | ✅ 기본 |
