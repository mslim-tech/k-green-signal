...
> 새 연도(예: 2026) 보고서를 **기존 std_id를 흔들지 않고 안전하게 추가**하는 절차는 [`ADD_YEAR.md`](./docs/ADD_YEAR.md) 참고.
...
- **새 연도 추가 절차**: [`docs/ADD_YEAR.md`](./docs/ADD_YEAR.md) (증분 통합으로 새 연도를 안전하게 붙이는 로컬 단계별 가이드)
